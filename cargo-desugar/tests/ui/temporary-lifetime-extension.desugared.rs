...
#![allow(unused_parens, internal_features)]
...
fn main() {
    ...
    let b_17 = [(&temp(),)];
    let c_25 = &temp().0;
    let d_36 = &*<std::string::String as std::ops::Index<std::ops::RangeFull>>::index(
        &temp().0,
        std::ops::RangeFull {},
    );
    let e_54 = {
